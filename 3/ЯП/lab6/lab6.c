...
{
    printf("Number of group     Full Name      Math     English     Physics     History    Astronomy    Grade point average\n");
    int i = 0;
    for (; i < lenArr; i++)
        printf("%15d%14s%9d%10d%12d%12d%12d%19.3f\n", ProcGroups[i].Num, ProcGroups[i].Group.Name, ProcGroups[i].Group.Mark[0], 
               ProcGroups[i].Group.Mark[1], ProcGroups[i].Group.Mark[2], ProcGroups[i].Group.Mark[3], ProcGroups[i].Group.Mark[4],
               (double)(ProcGroups[i].Group.Mark[0]+ProcGroups[i].Group.Mark[1]+ProcGroups[i].Group.Mark[2]+ProcGroups[i].Group.Mark[3]+ProcGroups[i].Group.Mark[4]) / 5);
}  
